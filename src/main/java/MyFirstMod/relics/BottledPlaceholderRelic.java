...
import MyFirstMod.patches.relics.BottledPlaceholderField;
import MyFirstMod.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static MyFirstMod.DefaultMod.makeRelicOutlinePath;
import static MyFirstMod.DefaultMod.makeRelicPath;
