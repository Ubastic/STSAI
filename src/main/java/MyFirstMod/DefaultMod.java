...
import MyFirstMod.commands.*;
import MyFirstMod.items.FightAIItem;
import basemod.*;
...
import MyFirstMod.cards.*;
import MyFirstMod.characters.TheDefault;
import MyFirstMod.events.IdentityCrisisEvent;
import MyFirstMod.potions.PlaceholderPotion;
import MyFirstMod.potions.BarricadePotion;
import MyFirstMod.relics.BottledPlaceholderRelic;
import MyFirstMod.relics.DefaultClickableRelic;
import MyFirstMod.relics.PlaceholderRelic;
import MyFirstMod.relics.PlaceholderRelic2;
import MyFirstMod.util.IDCheckDontTouchPls;
import MyFirstMod.util.TextureLoader;
import MyFirstMod.variables.DefaultCustomVariable;
import MyFirstMod.variables.DefaultSecondMagicNumber;
...
public class DefaultMod implements
    ...
    private static final String ATTACK_DEFAULT_GRAY = "MyFirstModResources/images/512/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY = "MyFirstModResources/images/512/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY = "MyFirstModResources/images/512/bg_power_default_gray.png";
    
    private static final String ENERGY_ORB_DEFAULT_GRAY = "MyFirstModResources/images/512/card_default_gray_orb.png";
    private static final String CARD_ENERGY_ORB = "MyFirstModResources/images/512/card_small_orb.png";
    
    private static final String ATTACK_DEFAULT_GRAY_PORTRAIT = "MyFirstModResources/images/1024/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY_PORTRAIT = "MyFirstModResources/images/1024/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY_PORTRAIT = "MyFirstModResources/images/1024/bg_power_default_gray.png";
    private static final String ENERGY_ORB_DEFAULT_GRAY_PORTRAIT = "MyFirstModResources/images/1024/card_default_gray_orb.png";
    
    // Character assets
    private static final String THE_DEFAULT_BUTTON = "MyFirstModResources/images/charSelect/DefaultCharacterButton.png";
    private static final String THE_DEFAULT_PORTRAIT = "MyFirstModResources/images/charSelect/DefaultCharacterPortraitBG.png";
    public static final String THE_DEFAULT_SHOULDER_1 = "MyFirstModResources/images/char/defaultCharacter/shoulder.png";
    public static final String THE_DEFAULT_SHOULDER_2 = "MyFirstModResources/images/char/defaultCharacter/shoulder2.png";
    public static final String THE_DEFAULT_CORPSE = "MyFirstModResources/images/char/defaultCharacter/corpse.png";
    
    //Mod Badge - A small icon that appears in the mod settings menu next to your mod.
    public static final String BADGE_IMAGE = "MyFirstModResources/images/Badge.png";
    
    // Atlas and JSON files for the Animations
    public static final String THE_DEFAULT_SKELETON_ATLAS = "MyFirstModResources/images/char/defaultCharacter/skeleton.atlas";
    public static final String THE_DEFAULT_SKELETON_JSON = "MyFirstModResources/images/char/defaultCharacter/skeleton.json";
    ...
    public void receiveEditPotions() {
        ...
        BaseMod.addPotion(BarricadePotion.class, PLACEHOLDER_POTION_LIQUID, PLACEHOLDER_POTION_HYBRID, PLACEHOLDER_POTION_SPOTS, BarricadePotion.POTION_ID);
