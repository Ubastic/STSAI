...
import SlayTheSpireAIMod.cards.*;
import SlayTheSpireAIMod.characters.TheDefault;
import SlayTheSpireAIMod.events.IdentityCrisisEvent;
import SlayTheSpireAIMod.potions.PlaceholderPotion;
import SlayTheSpireAIMod.potions.BarricadePotion;
import SlayTheSpireAIMod.relics.BottledPlaceholderRelic;
import SlayTheSpireAIMod.relics.DefaultClickableRelic;
import SlayTheSpireAIMod.relics.PlaceholderRelic;
import SlayTheSpireAIMod.relics.PlaceholderRelic2;
import SlayTheSpireAIMod.util.IDCheckDontTouchPls;
import SlayTheSpireAIMod.util.TextureLoader;
import SlayTheSpireAIMod.variables.DefaultCustomVariable;
import SlayTheSpireAIMod.variables.DefaultSecondMagicNumber;
...
public class DefaultMod implements
    ...
    private static final String ATTACK_DEFAULT_GRAY = "SlayTheSpireAIModResources/images/512/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY = "SlayTheSpireAIModResources/images/512/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY = "SlayTheSpireAIModResources/images/512/bg_power_default_gray.png";
    
    private static final String ENERGY_ORB_DEFAULT_GRAY = "SlayTheSpireAIModResources/images/512/card_default_gray_orb.png";
    private static final String CARD_ENERGY_ORB = "SlayTheSpireAIModResources/images/512/card_small_orb.png";
    
    private static final String ATTACK_DEFAULT_GRAY_PORTRAIT = "SlayTheSpireAIModResources/images/1024/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY_PORTRAIT = "SlayTheSpireAIModResources/images/1024/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY_PORTRAIT = "SlayTheSpireAIModResources/images/1024/bg_power_default_gray.png";
    private static final String ENERGY_ORB_DEFAULT_GRAY_PORTRAIT = "SlayTheSpireAIModResources/images/1024/card_default_gray_orb.png";
    
    // Character assets
    private static final String THE_DEFAULT_BUTTON = "SlayTheSpireAIModResources/images/charSelect/DefaultCharacterButton.png";
    private static final String THE_DEFAULT_PORTRAIT = "SlayTheSpireAIModResources/images/charSelect/DefaultCharacterPortraitBG.png";
    public static final String THE_DEFAULT_SHOULDER_1 = "SlayTheSpireAIModResources/images/char/defaultCharacter/shoulder.png";
    public static final String THE_DEFAULT_SHOULDER_2 = "SlayTheSpireAIModResources/images/char/defaultCharacter/shoulder2.png";
    public static final String THE_DEFAULT_CORPSE = "SlayTheSpireAIModResources/images/char/defaultCharacter/corpse.png";
    
    //Mod Badge - A small icon that appears in the mod settings menu next to your mod.
    public static final String BADGE_IMAGE = "SlayTheSpireAIModResources/images/Badge.png";
    
    // Atlas and JSON files for the Animations
    public static final String THE_DEFAULT_SKELETON_ATLAS = "SlayTheSpireAIModResources/images/char/defaultCharacter/skeleton.atlas";
    public static final String THE_DEFAULT_SKELETON_JSON = "SlayTheSpireAIModResources/images/char/defaultCharacter/skeleton.json";
